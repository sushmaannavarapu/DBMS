                ...
                <div class="col-lg-6">
                    <div class="section-title  text-center">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="bookpublisher" placeholder="Book Publisher">
                        
                        </div>
                        
                        <button type="submit" name="book" class="btn btn-primary">Add Book</button>
                        </form>
...
<?php 
    ...
    $query = "insert into book values('$book_id','$book_name','$book_author','$book_publisher')";
